...
<html lang="en">
    ...
    <body>
            ...
            <tbody>
                <tr>
                    ...
                    <td class="border-0 pl-0">
                        ...
                        <p>{{ __('Fecha de emicion') }}: <strong>{{ $invoice->getDate() }}</strong></p>
                    </td>
                </tr>
            </tbody>
        </table>
                ...
                <tr>
                    <td class="px-0">
                        @if($invoice->seller->name)
                            <p class="seller-name">
                                <strong>Conjunto Residencial Nuevo Collao</strong>
                            </p>
                        @endif

                        @if($invoice->seller->address)
                            <p class="seller-address">
                                Direccion: Collao 1585
                            </p>
                        @endif
        ...
        <table class="table">
            <thead>
                <tr>
                    <th scope="col" class="border-0 pl-0">{{ __('Mes canelado') }}</th>
                    <th scope="col" class="text-right border-0">{{ __('Monto') }}</th
